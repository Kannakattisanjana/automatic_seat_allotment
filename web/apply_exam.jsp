 ...
 <div class="w3-col m4">
  ...
  <form class="w3-container" action="">
    ...
    <%
           ...
           try{
               ...
               con = DriverManager.getConnection("jdbc:mysql://localhost:3306/test", "root", "root");
                 st = con.createStatement();
                    ...
                    String query = "select subject_id,name from subject where Branch_id ="+request.getParameter("branch")+" and sem ="+request.getParameter("sem")+" and scheme ="+request.getParameter("scheme");
     ...
     <td><input type="text"  name="subcode" id="subname" value='<%=rs.getString("name")%>'>
    </td>
