    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-col m4">
        <select class="w3-select w3-border w3-blue" name="option" style="border-radius: 12px;">
          ...
          <option value="1">1st Subject(17cs11)</option>
          <option value="2">2nd Subject(17cs12)</option>
          <option value="3">3rd Subject(17cs13)</option>
          <option value="4">4th Subject(17cs14)</option>
          <option value="5">5th Subject(17cs15)</option>
          <option value="6">6th Subject(17cs16)</option>
          <option value="7">7th Subject(17cs17)</option>
          <option value="8">8th Subject(17cs18)</option>
        </select>
      </div>
        <div class="w3-col m1">
          <h2></h2>
