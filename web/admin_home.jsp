 ...
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
     ...
     <div class="w3-dropdown-hover w3-hide-small w3-bar-item w3-button w3-hover-white">
        ...
        <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:250px">
          ...
          <a href="#" class="w3-bar-item w3-button w3-hover-blue">Delete Subjec</a>
          <a href="#" class="w3-bar-item w3-button w3-hover-blue">Add Subjec</a>
          </div>
      </div>
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <h4 class="w3-center">MAIN ADMIN</h4>
         <hr>
               ...
               <br><br>
                <form>
                    ...
                    <div class="w3-row-padding">
                        ...
                        <div class="w3-col m4">
                            <label for="group">Select Branch</label></br>
                        ...
                        <button type="submit" id="post" class="w3-button w3-theme w3-right " name="Upload" >Post</button>
               </div>
                </form>
                    </div>
                      </div>
...
Statement st=con.createStatement();
  ...
  // System.out.println("insert into message("+message+","+type+","+Branch_id+","+adminid+","+"now(),);");
                  ps.setString(1, message);
                 ps.setString(2, type);
                 ps.setInt(3, Integer.parseInt(Branch_id));
                ps.setInt(4,Integer.parseInt(session.getAttribute("id").toString()));
